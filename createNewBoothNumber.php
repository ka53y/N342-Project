...
<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
            ...
            <div class="card card-1">
                <div class="card-heading">Create New Booth Number</div>
                <div class="card-body">

			<form action="createNewBoothNumberSend.php" method="post">
    				<div>
        <!-- every one of my form inputs will be set up like this no matter the type, label in bold, then input, feel free to change -->
					<div class="input-group">
        					<label for="newBoothNumber"><b>New Booth Number</b></label>
        					<input type="text" placeholder="Enter A New Booth Number" name="newBoothNumber" required>
					</div>
