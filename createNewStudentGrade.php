...
<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            <div class="card-heading">Create New Student Grade Level</div>
            <div class="card-body">

                <form action="createNewStudentGradeSend.php" method="post">
                    <div>
                        <!-- every one of my form inputs will be set up like this no matter the type, label in bold, then input, feel free to change -->
                        <div class="input-group">
                            <label for="newStudentGrade"><b>New Student Grade Level</b></label>
                            <input type="text" placeholder="Enter A New Student Grade Level" name="newStudentGrade" required>
                        </div>
