...
<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
    <div class="wrapper wrapper--w680">
        <div class="card card-1">
            <div class="card-heading">Create New Category</div>
            <div class="card-body">

                <form action="createNewCategorySend.php" method="post">
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" placeholder="Enter A New Category" name="newCategory" required>
                        </div>
